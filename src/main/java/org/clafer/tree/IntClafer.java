...
public class IntClafer extends AtomicClafer {
    ...
    protected void print(Solver solver, String indent, int parent, Appendable output) {
        throw new UnsupportedOperationException("Ccannot pring primitive int clafer");
    }
    ...
    protected void optimize(Model model, Card parentCard) {
        throw new UnsupportedOperationException("Cannot update global cardinality of primitive int clafer");
    }
}
