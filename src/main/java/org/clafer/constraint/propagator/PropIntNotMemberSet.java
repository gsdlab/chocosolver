...
public class PropIntNotMemberSet extends Propagator<Variable> {
    ...
    public PropIntNotMemberSet(IntVar element, SetVar set) {
        super(new Variable[]{element, set}, PropagatorPriority.BINARY);
...
//    }
    ...
    public ESat isEntailed() {
        ...
        if (PropUtil.intersects(element, set)) {
            return ESat.FALSE;
        }
        return PropUtil.canIntersect(element, set) ? ESat.UNDEFINED : ESat.TRUE;
    }
