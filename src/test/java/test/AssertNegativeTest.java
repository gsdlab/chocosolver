...
/**
 * Tests with assertions where violations are expected.
 *
 * @author jimmy
 */
@RunWith(Parameterized.class)
public class AssertNegativeTest {
    ...
    public static List<File[]> testFiles() throws URISyntaxException {
        File dir = new File(OptimizationTest.class.getResource("/assert-negative").toURI());
