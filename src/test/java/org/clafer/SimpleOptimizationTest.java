...
public class SimpleOptimizationTest {
    ...
    public void testMinimalSolutionKnown() {
        ...
        ClaferObjective solver = ClaferCompiler.compileMinimize(model, Scope.defaultScope(3), a.getRef());
    ...
    public void testMaximalSolutionKnown() {
        ...
        ClaferObjective solver = ClaferCompiler.compileMaximize(model, Scope.defaultScope(3), a.getRef());
        assertEquals(6, solver.optimal().getFst().intValue());
    }
}
