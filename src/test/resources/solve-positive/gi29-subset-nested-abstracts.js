...
c0_ExceptionPort = c0_Component.addAbstractChild("c0_ExceptionPort");
...
c0_ExceptionPort.extending(c0_Port);
c0_allPorts.refToUnique(c0_Port);
c0_Component.addConstraint(equal(joinRef(join($this(), c0_allPorts)), join($this(), c0_Port)));
c0_WinController.extending(c0_Component);
c0_cmd.extending(c0_Port);
c0_powerOut.extending(c0_ExceptionPort);
